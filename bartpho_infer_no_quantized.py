...
if __name__ == '__main__':
    ...
    for article in tqdm(data):
        ...
        for no_sen in range(3, 10):
            ...
            record[f"sum_{no_sen}"] = tokenizer.decode(output_ids[0], skip_special_tokens=False)
            # print("----------------")
    ...
    df.to_excel(os.path.join(WORKING_DIR, "data/231011_summary_bartpho.xlsx"), sheet_name="summary", index=False)
